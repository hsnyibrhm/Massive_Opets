...
class detail_bayar_penitipan : AppCompatActivity(), View.OnClickListener {

    // Daftar ID tombol
    private val buttonIds = listOf(
        R.id.btn_brt1, R.id.btn_brt2, R.id.btn_brt3, R.id.btn_fitur1, R.id.btn_fitur2,
        R.id.btn_fitur3, R.id.btn_fitur4
    )
    // Daftar tombol
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val onBackPressedCallback = object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                ...
                val intent = Intent(this@detail_bayar_penitipan, PenitipanActivity::class.java)
